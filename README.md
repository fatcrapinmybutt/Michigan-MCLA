...
### SCAO Court Forms
- **[`forms.md`](forms.md)** — Comprehensive human-readable catalogue of SCAO-approved court forms covering MC, CC, DC, FOC, PC, JC, DM, PPO, Criminal, and Appellate form families (160+ forms).
- **[`forms.json`](forms.json)** — Machine-readable SCAO forms data organized by form family, with form IDs, titles, purposes, governing rules/statutes, and download URLs.
